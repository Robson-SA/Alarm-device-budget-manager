...
public class ProdutoController {
    ...
    @GetMapping
    public ResponseEntity<Page<ProdutoDTO>> findAllPaged (@PageableDefault(size = 10, sort = "nome") Pageable pageable) {
    ...
    public ResponseEntity<Page<ProdutoDTO>> findByCodigo(@RequestParam(name="codigo", defaultValue = "") String nome, Pageable pageable){
	...
	public ResponseEntity<ProdutoDTO> update(@RequestParam(name = "codigo", defaultValue = "") String codigo, @RequestBody ProdutoDTO dto) {
